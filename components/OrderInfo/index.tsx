...
const OrderInfo = () => {
  return (
    <section className="relative w-full lg:h-[43.375rem] md:h-[22.3125rem] xs:h-[44.75rem] h-[44.75rem]">
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10 h-full pt-[7.5rem] md:pt-[5rem] xs:pt-[3rem] flex flex-col items-center">
        <div className="w-full max-w-[71.75rem]">
          ...
          <div className="flex flex-col lg:flex-row md:flex-row xs:flex-col gap-5">
            {/* Sample Card */}
